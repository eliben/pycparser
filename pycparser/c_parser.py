...
class CParser(PLYParser):
    ...
    def p_pp_directive(self, p):
        ...
        self._parse_error('Directives not supported yet',
            self._coord(p.lineno(1), self.clex.find_tok_column(p.slice[1])))
    ...
    def p_function_definition_1(self, p):
        ...
        spec = dict(
            ...
            type=[c_ast.IdentifierType(['int'],
                coord=self._coord(
                    p.lineno(1), self.clex.find_tok_column(p.slice[1])))],
            function=[])
    ...
    def p_type_specifier_1(self, p):
        ...
        p[0] = c_ast.IdentifierType([p[1]], 
            coord=self._coord(p.lineno(1), self.clex.find_tok_column(p.slice[1])))
    ...
    def p_struct_or_union_specifier_1(self, p):
        ...
        p[0] = klass(
            name=p[2],
            decls=None,
            coord=self._coord(p.lineno(2), self.clex.find_tok_column(p.slice[2])))
        ...
        if len(p) == 2:
            enumerator = c_ast.Enumerator(
                        ...
                        self._coord(p.lineno(1), 
                            self.clex.find_tok_column(p.slice[1])))
        else:
            enumerator = c_ast.Enumerator(
                        p[1], p[3],
                        self._coord(p.lineno(1), 
    ...
    def p_declarator_3(self, p):
        ...
        decl = c_ast.TypeDecl(
            ...
            coord=self._coord(p.lineno(2), 
                self.clex.find_tok_column(p.slice[2])))
    ...
    def p_direct_declarator_5(self, p):
        ...
        arr = c_ast.ArrayDecl(
            ...
            dim=c_ast.ID(p[4], self._coord(p.lineno(4), 
                self.clex.find_tok_column(p.slice[4]))),
    ...
    def p_parameter_type_list(self, p):
        ...
        if len(p) > 2:
            p[1].params.append(c_ast.EllipsisParam(
                self._coord(p.lineno(3), self.clex.find_tok_column(p.slice[3]))))
    ...
    def p_direct_abstract_declarator_4(self, p):
        ...
        arr = c_ast.ArrayDecl(
            ...
            dim=c_ast.ID(p[3], self._coord(p.lineno(3), 
                self.clex.find_tok_column(p.slice[3]))),
            dim_quals=[],
            coord=p[1].coord)
